...
const { getRequestParam } = require('./wetransfer_download')
...
class Upload extends EventEmitter {
    ...
    formatRequestOption(method, url, body) {
        ...
        return {
            ...
            headers: {
                ...
                'X-CSRF-Token': this.rd.csrfToken
            },
            json: true,
            simple: true,
            jar: requestPromise.jar().setCookie(this.rd.cookieJar, "https://wetransfer.com"),
    ...
    emailRequest() {
        ...
        return new Promise((resolve, reject) => {
            debug("emailRequest")
            this.requestCue.emailRequest = got(
                url,
                {
                    method: 'post',
    ...
    uploadFileWF(currentPayload) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            let uploadFileStream = currentPayload.stream;
            try {
    ...
    fileRequest(filename, chunk_size) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.requestCue.fileRequest = got(
    ...
    chunkRequest(fileID, chunk_number, chunk_size, retries) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.requestCue.chunkRequest = got(
